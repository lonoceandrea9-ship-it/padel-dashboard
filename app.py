...
# Initialize squad roster in session_state so coach edits persist during the session
    ...
    <body>
        ...
        <script>
            ...
            function shareOnWhatsApp() {{
                ...
                const text = encodeURIComponent("🎾 Padel Performance Hub - {current_player['fname']} {current_player['lname']}\\nTechnical avg: " + (tech.reduce((a,b)=>a+b,0)/6).toFixed(1) + "\\nMental avg: " + (mental.reduce((a,b)=>a+b,0)/6).toFixed(1));
