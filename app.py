...
# Initialize navigation and language state if not present
...
# Dictionary of multi-language UI elements
translations = {
    "English": {
        ...
        "logout": "🚪 Log Out",
        "coach_dashboard_title": "📋 Coach Dashboard - Squad Management & Evaluations",
        "coach_dashboard_desc": "As a coach, you can view all players and modify their **Coach Evaluations & Comparisons**.",
        "select_player_eval": "Select player to review/edit coach evaluations:",
        "coach_editing": "Editing Coach Ratings for:",
        "coach_info": "💡 As coach, you can modify the values below and save them. The player will see these updates in read-only mode.",
        "tech_skills_coach": "Technical Skills (Coach Evaluation)",
        "tactics_skills_coach": "Tactics & Mental Skills (Coach Evaluation)",
        "save_coach_eval": "💾 Save Coach Evaluations",
        "save_success": "Successfully updated coach evaluations for",
        "personal_card": "👤 Personal Card:",
        "side": "Side",
        "ratings_from": "Ratings from 1 to 10"
    },
    "Italiano": {
        ...
        "logout": "🚪 Disconnetti",
        "coach_dashboard_title": "📋 Dashboard Allenatore - Gestione Squadra e Valutazioni",
        "coach_dashboard_desc": "Come allenatore, puoi visualizzare tutti i giocatori e modificare le loro **Valutazioni e Comparazioni dell'Allenatore**.",
        "select_player_eval": "Seleziona il giocatore da esaminare/modificare:",
        "coach_editing": "Modifica valutazioni per:",
        "coach_info": "💡 Come allenatore, puoi modificare i valori sottostanti e salvarli. Il giocatore vedrà questi aggiornamenti in sola lettura.",
        "tech_skills_coach": "Abilità Tecniche (Valutazione Allenatore)",
        "tactics_skills_coach": "Tattica e Abilità Mentali (Valutazione Allenatore)",
        "save_coach_eval": "💾 Salva Valutazioni Allenatore",
        "save_success": "Valutazioni aggiornate con successo per",
        "personal_card": "👤 Scheda Personale:",
        "side": "Lato",
        "ratings_from": "Valutazioni da 1 a 10"
    },
    "Español": {
        ...
        "coach_dashboard_title": "📋 Panel de Entrenador - Gestión de Equipo y Evaluaciones",
        "coach_dashboard_desc": "Como entrenador, puedes ver a todos los jugadores y modificar sus **Evaluaciones y Comparaciones del Entrenador**.",
        "select_player_eval": "Selecciona el jugador para revisar/editar evaluaciones:",
        "coach_editing": "Editando calificaciones del entrenador para:",
        "coach_info": "💡 Como entrenador, puedes modificar los valores a continuación y guardarlos. El jugador verá estas actualizaciones en modo de solo lectura.",
        "tech_skills_coach": "Habilidades Técnicas (Evaluación del Entrenador)",
        "tactics_skills_coach": "Táctica y Habilidades Mentales (Evaluación del Entrenador)",
        "save_coach_eval": "💾 Guardar Evaluaciones del Entrenador",
        "save_success": "Evaluaciones actualizadas con éxito para",
        "personal_card": "👤 Tarjeta Personal:",
        "side": "Lado",
        "ratings_from": "Puntuaciones del 1 al 10"
    },
    "Svenska": {
        ...
        "logout": "🚪 Logga ut",
        "coach_dashboard_title": "📋 Tränarpanel - Trupphantering och Utvärderingar",
        "coach_dashboard_desc": "Som tränare kan du se alla spelare och ändra deras **Tränarutvärderingar & Jämförelser**.",
        "select_player_eval": "Välj spelare att granska/redigera tränarutvärderingar:",
        "coach_editing": "Redigerar tränarbetyg för:",
        "coach_info": "💡 Som tränare kan du ändra värdena nedan och spara dem. Spelaren kommer att se dessa uppdateringar i skrivskyddat läge.",
        "tech_skills_coach": "Tekniska Färdigheter (Tränarutvärdering)",
        "tactics_skills_coach": "Taktik & Mentala Färdigheter (Tränarutvärdering)",
        "save_coach_eval": "💾 Spara Tränarutvärderingar",
        "save_success": "Framgångsrikt uppdaterade tränarutvärderingar för",
        "personal_card": "👤 Personligt kort:",
        "side": "Sida",
        "ratings_from": "Betyg från 1 till 10"
    },
    "Nederlands": {
        ...
        "logout": "🚪 Uitloggen",
        "coach_dashboard_title": "📋 Coach Dashboard - Selectiebeheer & Evaluaties",
        "coach_dashboard_desc": "Als coach kun je alle spelers bekijken en hun **Coach Evaluaties & Vergelijkingen** aanpassen.",
        "select_player_eval": "Selecteer speler om coachevaluaties te bekijken/bewerken:",
        "coach_editing": "Coachbeoordelingen bewerken voor:",
        "coach_info": "💡 Als coach kun je de onderstaande waarden wijzigen en opslaan. De speler ziet deze updates in alleen-lezen modus.",
        "tech_skills_coach": "Technische Vaardigheden (Coach Evaluatie)",
        "tactics_skills_coach": "Tactiek & Mentale Vaardigheden (Coach Evaluatie)",
        "save_coach_eval": "💾 Coachevaluaties Opslaan",
        "save_success": "Coachevaluaties succesvol bijgewerkt voor",
        "personal_card": "👤 Persoonlijke Kaart:",
        "side": "Kant",
        "ratings_from": "Beoordelingen van 1 tot 10"
    },
    "Dansk": {
        ...
        "logout": "🚪 Log ud",
        "coach_dashboard_title": "📋 Træner Dashboard - Truphåndtering & Evalueringer",
        "coach_dashboard_desc": "Som træner kan du se alle spillere og ændre deres **Trænerevalueringer & Sammenligninger**.",
        "select_player_eval": "Vælg spiller til gennemgang/redigering af trænerevalueringer:",
        "coach_editing": "Redigerer trænervurderinger for:",
        "coach_info": "💡 Som træner kan du ændre værdierne nedenfor og gemme dem. Spilleren vil se disse opdateringer i skrivebeskyttet tilstand.",
        "tech_skills_coach": "Tekniske Færdigheder (Trænerevaluering)",
        "tactics_skills_coach": "Taktik & Mentale Færdigheder (Trænerevaluering)",
        "save_coach_eval": "💾 Gem Trænerevalueringer",
        "save_success": "Trænerevalueringer opdateret for",
        "personal_card": "👤 Personligt Kort:",
        "side": "Side",
        "ratings_from": "Bedømmelser fra 1 til 10"
    }
}

t = translations[st.session_state.language]

# Global language selector on top of the sidebar or header
with st.sidebar:
...
# --- COACH DASHBOARD ---
    ...
    with col_top1:
        st.title(t["coach_dashboard_title"])
        st.markdown(t["coach_dashboard_desc"])
    with col_top2:
    ...
    player_options = [f"{p['fname']} {p['lname']} ({p['side']})" for p in st.session_state.squad_players]
    selected_player_str = st.selectbox(t["select_player_eval"], player_options)
    
    selected_idx = player_options.index(selected_player_str)
    current_player = st.session_state.squad_players[selected_idx]
    
    st.subheader(f"{t['coach_editing']} {current_player['fname']} {current_player['lname']}")
    st.info(t["coach_info"])
    
    with st.form("coach_edit_form"):
        st.markdown(f"#### {t['tech_skills_coach']}")
        c_tech_inputs = []
        ...
        st.markdown(f"#### {t['tactics_skills_coach']}")
        c_mental_inputs = []
        ...
        submitted_coach = st.form_submit_button(t["save_coach_eval"], type="primary")
        if submitted_coach:
            ...
            st.success(f"{t['save_success']} {current_player['fname']} {current_player['lname']}!")
...
# --- INDIVIDUAL PLAYER DASHBOARD ---
    ...
    col_top1, col_top2 = st.columns([6, 1])
    with col_top1:
        st.title(f"{t['personal_card']} {current_player['fname']} {current_player['lname']} ({current_player['side']})")
    with col_top2:
        if st.button(t["logout"]):
            st.session_state.authenticated_player = None
            st.session_state.nav_mode = "Home"
