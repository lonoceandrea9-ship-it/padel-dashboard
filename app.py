...
if modalita == "📋 Area Allenatore (Coach)":
    ...
    # Password per l'allenatore (puoi cambiarla qui sotto)
...
# CONTROLLO ACCESSO: Se si seleziona Coach ma non è autenticato, blocchiamo la vista
if modalita == "📋 Area Allenatore (Coach)" and not st.session_state.authenticated_coach:
    ...
    default_players = [
        {
            "fname": "Marco", "lname": "Rossi",
            "tech": [7, 6, 7, 7, 8, 5],
            "mental": [8, 6, 7, 7, 8, 6],
            "c_tech": [6, 5, 6, 6, 7, 4],
            "c_mental": [7, 5, 6, 6, 7, 5]
        },
        {
            "fname": "Luca", "lname": "Bianchi",
            "tech": [8, 5, 7, 6, 7, 4],
            "mental": [7, 5, 8, 6, 7, 6],
            "c_tech": [7, 4, 6, 5, 6, 3],
            "c_mental": [6, 4, 7, 5, 6, 5]
        },
        {
            "fname": "Giorgio", "lname": "Neri",
            "tech": [6, 8, 7, 7, 6, 7],
            "mental": [6, 8, 6, 8, 7, 7],
            "c_tech": [5, 6, 6, 6, 5, 6],
            "c_mental": [5, 6, 5, 7, 6, 6]
        }
    ]
    ...
    if uploaded_files:
        ...
        players_data = default_players
        st.sidebar.info("💡 Stai visualizzando dati dimostrativi. Carica i file JSON dei giocatori per analizzare i dati reali.")
