...
if modalita == "📋 Area Allenatore (Coach)" and not st.session_state.authenticated_coach:
    ...
    # Lista completa dei giocatori estratta dall'immagine
    default_players = [
    ...
    if uploaded_files:
        ...
        st.sidebar.info("💡 Stai visualizzando la squadra completa caricata dall'immagine. I giocatori possono comunque inviarti i loro file JSON per aggiornare i dati.")
